...
:::message
agentにメトリクスのJSONをそのまま貼るだけでも十分役立ちますが、以下のような注意書きを添えると解釈の精度が上がりました[^1]:

- CPU-boundな処理は除外（parallelに動かしているテストなど）
- JavaやDockerなどubuntu-slimで利用できないツールの明記
- 15分の実行時間制限などその他制約
:::
...
[^1]: [gh-slimifyのREADME](https://github.com/fchimpan/gh-slimify/blob/1566c119fb8b1c51403d151869e27e82ce56d614/README.md?plain=1#L13-L37)には実用的なprompt例が記載されています。
